...
// categories
export const ADD_CATEGORY_START = "DELETE_CATEGORY_START";
export const ADD_CATEGORY_SUCCESS = "DELETE_CATEGORY_SUCCESS";
export const ADD_CATEGORY_FAIL = "DELETE_CATEGORY_FAIL";
